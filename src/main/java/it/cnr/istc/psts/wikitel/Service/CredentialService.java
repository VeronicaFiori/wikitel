...
//    public Credentials subscribeUser(Long userId) {
//        // Trova l'utente con l'ID specificato
//        Credentials user = credentialsRepository.findById(userId).orElse(null);
//        if (user != null) {
//            // Iscrivi l'utente impostando il flag isEnabled a true
...
//    }
//    
//    public Credentials unsubscribeUser(Long userId) {
//        // Trova l'utente con l'ID specificato
//        Credentials user = credentialsRepository.findById(userId).orElse(null);
//        if (user != null) {
//            // Disiscrivi l'utente impostando il flag isEnabled a false
