const colors = [
    '#FF6F61', // Rosso Corallo
    '#B0E0E6', // Blu Polvere
    '#98FF98', // Verde Menta
    '#FFD700', // Giallo Sole
    '#FF4500', // Arancione Tramonto
    '#E6E6FA', // Lavanda
    '#40E0D0', // Turchese
    '#FF69B4', // Rosa Caldo
    '#4682B4', // Azzurro Acciaio
    '#DA70D6'  // Viola Orchidea
];
var $jscomp = $jscomp || {};
$jscomp.scope = {};
...
function applyRandomColorsToGoals() {
...
function deletelesson(id) {
    $.ajax({
        type: "POST", contentType: "application/json", url: "/deletelesson/" + id, success: function (a) {
...
function lessionopt(id) {
    ...
    $.ajax({
        type: "GET", contentType: "application/json", url: "/getrulecat/" + id, success: function (a) {
            console.log("SUCCESS : ", a);
...
function GetStudent() {
    $.ajax({
        type: "GET", contentType: "application/json", url: "/getstudents", dataType: "json", success: function (a) {
            console.log("SUCCESS : ", a);
...
function Create_new_lesson() {
    var goals = updateContainerOrder();
    if (0 == students_id.length) {
        ...
        var c = {
            ...
            type: document.querySelector('input[name="selectype"]:checked').value
        };
