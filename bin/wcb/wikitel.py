    ...
    def get(self):
        ...
        try:
            ...
            if not wiki_page.exists():
                ...
                response_data = {'exists': 'false', 'suggest': suggestions, 'maybe': search_results}
            ...
            rank1 = list(cosine_similarity(tfidf_matrix_train[0:1], tfidf_matrix_train)[0])[1:]
            rank2 = list(cosine_similarity(tfidf_matrix_train2[0:1], tfidf_matrix_train2)[0])[1:]
            response_data = {
                'url': url,
